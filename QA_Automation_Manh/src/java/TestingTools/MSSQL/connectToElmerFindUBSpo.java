...
public class connectToElmerFindUBSpo {


    public static void connectToElmerFindWBSpo(String[] poid) throws SQLException, ClassNotFoundException {
        ...
        String sqlStr = "select PurchaseOrderId FROM [ELMER_MANHATTAN].[dbo].[PurchaseOrderResequence] where [PurchaseOrderId] = '" + poid + "' "  ;
