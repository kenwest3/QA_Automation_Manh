...
//https://code.google.com/p/commons-net-ssh/source/browse/src/main/java/org/apache/commons/net/ssh/SessionFactory.java?r=188
import java.io.File;
...
public class SSHClient extends SocketClient implements SessionFactory
{
    ...
    {
        //trans.addHostKeyVerifier(hostKeyVerifier);  Ken wEstberg attempt at resolving method not working
    ...
    protected void doKex() throws TransportException
    {
        ...
        try
        {
            //trans.doKex();                        Ken wEstberg attempt at resolving method not working
