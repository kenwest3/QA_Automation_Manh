...
class Telnet extends SocketClient
{
     ...
     ***/                                                               //    TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT                 Terminal TYPE =vt102
            ...
            throws IOException
    {
        ...
        if (terminalType != null)
        {
            ...
            //_output_.write(terminalType.getChars(1,4, ch[0], 4));
            //(terminalType.getChars(1,2,c, 1)));
    ...
    {
        //if (debug) System.err.println("Sending data: " + Byte.toString(cmd));
    ...
    final synchronized void _sendByte(int b)
            throws IOException
    {
        //if (debug) System.err.println("Sending byte: " + Integer.toString(b));
        _output_.write(b);
