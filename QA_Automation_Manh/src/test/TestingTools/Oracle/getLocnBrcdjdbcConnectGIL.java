...
public class getLocnBrcdjdbcConnectGIL {
    // JDBC driver name and database URL
    //static final String JDBC_DRIVER = "oracle.jdbc.driver.OracleDriver";
    static final String DB_URL = "jdbc:oracle:thin:@CTDAYQ2DB52:51521:QA2WGIL";
    ...
    public static List<locationData> getLocnBRCD(String Item, String Location) {
        ...
        try{
            ...
            String sql;
            String sql2;
            sql = " select lh.locn_brcd, ic.item_name from wm_gil.locn_hdr lh " +
                    "  inner join WM_GIL.PICK_LOCN_DTL pld on pld.LOCN_ID = lh.LOCN_ID  " +
                    "  inner join WM_GIL.Item_cbo ic on ic.ITEM_ID = pld.ITEM_ID " +
                    "  inner join WM_GIL.item_wms iw on iw.item_id = ic.ITEM_ID  " +
                    "  where lh.LOCN_BRCD like '2%' " +
                    "  and pld.max_invn_qty > 24 " +
                    "  and iw.XPIRE_DATE_REQD = '1' " +
                    "  and lh.LOCN_ID > 7  " +
                    "  and pld.ACTL_INVN_CASES = '0'  " +
                    "  and rownum < 10 " ;
            //sql = " SELECT locn_ID FROM PICK_LOCN_HDR where repl_locn_brcd = '931346309' ";
            sql2 = "ALTER Session SET Current_Schema = \"WM_GIL\" ";
