...
/**
 * Created by kwestberg on 5/29/2015.
 */
public class getInvUBS {
    WebElement element;
    String Warehouse = "SNW";
    String WHnum = "14";
    ...
    @Test(description="WaitingforText test")
    ...
    @Test(description="Writing line to UBS")
    ...
    public void mainTest() throws Exception {
        ...
        Thread.sleep(2000);
        WaitForText("Open PO's  ETA    Qty");
        WriteLn("14");//19491338001
        Thread.sleep(2000);
        WaitForText("On Hand:");//---HERE-HERE-HERE-HERE-HERE-HERE-HERE-HERE-HERE-HERE-HERE-HERE-HERE-HERE-HERE-HERE-HERE-HERE
